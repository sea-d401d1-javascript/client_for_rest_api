...
politicianRouter.post('/repPoliticians', jwtAuth, jsonParser, (req, res) => {
...
politicianRouter.put('/repPoliticians/:id', jwtAuth, jsonParser, (req, res) => {
...
politicianRouter.delete('/repPoliticians/:id', jwtAuth, (req, res) => {
